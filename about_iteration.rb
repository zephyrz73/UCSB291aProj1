...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # cumulatively apply operations in {} to the array of numbers with start value in ()
  end
  ...
  #   # code to read 'file'
  # we have a lot of files and also we have to make sure we open the file first
  # before perform code on the file
  #
